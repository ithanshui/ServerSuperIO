...
namespace ServerSuperIO.Server
{
    ...
    public delegate void AddDeviceCompletedHandler(int devid, string devName,bool isSuccess);
    ...
    /// <param name="devid"></param>
    /// <param name="scldev"></param>
    public delegate void DeleteDeviceCompletedHandler(int devid, string devName,bool isSuccess);
