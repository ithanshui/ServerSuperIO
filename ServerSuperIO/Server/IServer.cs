...
namespace ServerSuperIO.Server
{
    public interface IServer:IDisposable,ILoggerProvider,IConfigProvider
    {
        ...
        /// <returns></returns>
        bool AddGraphicsShow(IGraphicsShow graphicsShow);
        ...
        void ChangeDeviceComInfo(int devid, int oldCom, int oldBaud, int newCom, int newBaud);
        #endregion
        ...
        /// 设备管理器
        /// </summary>
        IDeviceManager<int, IRunDevice> DeviceManager { get; }
