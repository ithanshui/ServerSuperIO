...
namespace ServerSuperIO.Device
{
    public class BaseArgs :System.EventArgs
    {
        ...
        public BaseArgs(int devid, int devaddr, string devname) 
        {
    ...
    public class ComParameterExchangeArgs : BaseArgs
    {
        ...
        public ComParameterExchangeArgs(int devid, int devaddr, string devname, int port, int baud, int oldcom, int oldbaud, int newcom, int newbaud)
            : base(devid, devaddr, devname)
        {
            this._oldcom = oldcom;
    ...
    public class CommunicationArgs : BaseArgs
    {
        ...
        public CommunicationArgs(int devid, int devaddr, string devname, object ioparameter1, object ioparameter2)
            : base(devid, devaddr, devname)
        {
    ...
    {
        private byte[] _Data = new byte[] { };
        public SendDataArgs(int devid, int devaddr, string devname, object io1, object io2, byte[] data)
            : base(devid, devaddr, devname, io1, io2)
        {
            this._Data = data;
        }
    ...
    public class DeviceRuningLogArgs : BaseArgs
    {
        ...
        public DeviceRuningLogArgs(int devid, int devaddr, string devname, string statedesc)
            : base(devid, devaddr, devname)
        {
    ...
    public class DeviceObjectChangedArgs : BaseArgs
    {
        ...
        public DeviceObjectChangedArgs(int devid, int devaddr, string devname, object obj, DeviceType devtype)
            : base(devid, devaddr, devname)
        {
            _Object = obj;
            _DeviceType = devtype;
    ...
    ///// 删除设备事件对象
    ///// </summary>
    //public class DeleteDeviceCompletedArgs : BaseArgs
    //{
    //    public DeleteDeviceCompletedArgs(int devid, int devaddr, string devname)
    //        : base(devid, devaddr, devname)
    //    {
